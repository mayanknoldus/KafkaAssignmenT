...
object KafkaScalaConsumer extends App {
   ...
   */
  val topic = "kafka-topic-1"

  /**
   * A consumer is instantiated by providing the configuration.
   */
  val consumer: KafkaConsumer[String,UserMessage] = new KafkaConsumer[String,UserMessage](props)
  ...
  while (true) {
     ...
     */
    val records: ConsumerRecords[String,UserMessage] = consumer.poll(100)
